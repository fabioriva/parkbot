...
const useStyles = makeStyles((theme) => ({
  ...
  content: {
    ...
    // backgroundImage: 'url(https://images.unsplash.com/photo-1550645612-83f5d594b671?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80)',
...
export default function Dashboard({ children, pageTitle = 'ParkBot' }) {
